...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_LogoutCommandMessageProtoBuf_LogoutCommandMessageProtoBuf_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_LogoutCommandMessageProtoBuf_LogoutCommandMessageProtoBuf_2eproto}, {}};

static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_LogoutCommandMessageProtoBuf_2eproto[1];
static constexpr ::PROTOBUF_NAMESPACE_ID::EnumDescriptor const** file_level_enum_descriptors_LogoutCommandMessageProtoBuf_2eproto = nullptr;
static constexpr ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor const** file_level_service_descriptors_LogoutCommandMessageProtoBuf_2eproto = nullptr;
...
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_LogoutCommandMessageProtoBuf_2eproto_sccs[1] = {
...
void LogoutCommandMessageProtoBuf::InitAsDefaultInstance() {
}
class LogoutCommandMessageProtoBuf::_Internal {
 public:
};
...
void LogoutCommandMessageProtoBuf::SharedDtor() {
}

void LogoutCommandMessageProtoBuf::SetCachedSize(int size) const {
  _cached_size_.Set(size);
}
const LogoutCommandMessageProtoBuf& LogoutCommandMessageProtoBuf::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&::scc_info_LogoutCommandMessageProtoBuf_LogoutCommandMessageProtoBuf_2eproto.base);
...
const char* LogoutCommandMessageProtoBuf::_InternalParse(const char* ptr, ::PROTOBUF_NAMESPACE_ID::internal::ParseContext* ctx) {
...
bool LogoutCommandMessageProtoBuf::IsInitialized() const {
  return true;
}

void LogoutCommandMessageProtoBuf::InternalSwap(LogoutCommandMessageProtoBuf* other) {
  using std::swap;
  _internal_metadata_.Swap(&other->_internal_metadata_);
}

::PROTOBUF_NAMESPACE_ID::Metadata LogoutCommandMessageProtoBuf::GetMetadata() const {
