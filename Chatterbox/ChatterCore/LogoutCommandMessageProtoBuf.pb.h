...
PROTOBUF_NAMESPACE_OPEN
template<> ::ChatterCore::Protocols::LogoutCommandMessageProtoBuf* Arena::CreateMaybeMessage<::ChatterCore::Protocols::LogoutCommandMessageProtoBuf>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace ChatterCore {
namespace Protocols {
...
class LogoutCommandMessageProtoBuf :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:ChatterCore.Protocols.LogoutCommandMessageProtoBuf) */ {
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "ChatterCore.Protocols.LogoutCommandMessageProtoBuf";
  }
  private:
  ...
  // @@protoc_insertion_point(class_scope:ChatterCore.Protocols.LogoutCommandMessageProtoBuf)
 private:
  class _Internal;
